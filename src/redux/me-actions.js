...
const setMyDetails = (details) => {
  return async (dispatch) => {
    ...
    const payload = {
      ...
      authType: doctorDoc?.authType ?? details.authType ?? details.auth_type,
      isStandalone: doctorDoc?.isStandalone ?? details.isStandalone,
      signupType: doctorDoc?.signupType ?? details.signupType,
      baaAccepted: doctorDoc?.baaAccepted,
      baaSigned: doctorDoc?.baaSigned,
      baaVersion: doctorDoc?.baaVersion,
      baaSignedAt: doctorDoc?.baaSignedAt,
      baaSignerName: doctorDoc?.baaSignerName,
      baaPdfUrl: doctorDoc?.baaPdfUrl,
